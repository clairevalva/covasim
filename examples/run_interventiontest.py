'''
script for running Covasim scenarios, primarily for purposes 
of testing how to make an intervention. 

July 15, 2020 — Claire Valva
'''
...
metapars = dict(
    ...
    noise     = 0.12, # Use noise, optionally, was 0.10
    noisepar  = 'beta',
    rand_seed = 1,
            ...
            'ttq': {
              ...
              'pars': {
                  'interventions': [
                        ...
                        cv.contact_tracing(start_day=start_day, end_day = end_day, trace_probs=0.8, trace_time=1.0),
                    ]
                  }
              },
             }
