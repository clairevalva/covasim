...
# import parameters as cova_pars these would be the parameters from the cruiseship model
...
class Person(cv.Person):
    ...
    def __init__(self, age=0, sex=0, crew=False, contacts=0, uid = 0):
        self.uid      = uid #str(pl.randint(0,1e9)) # Unique identifier for this person
